...
def test_sudoku_board_validation():
    with open("test/test_validation_boards/good_input.txt", "r") as f:
        good_input = f.readlines()
    with open("test/test_validation_boards/bad_input_1.txt", "r") as f:
        bad_input_1 = f.readlines()
    with open("test/test_validation_boards/bad_input_2.txt", "r") as f:
        bad_input_2 = f.readlines()
    with open("test/test_validation_boards/bad_input_3.txt", "r") as f:
        bad_input_3 = f.readlines()
    with open("test/test_validation_boards/bad_input_4.txt", "r") as f:
